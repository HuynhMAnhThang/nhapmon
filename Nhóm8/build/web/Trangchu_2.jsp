        ...
        <div style="width: 1070px" class="container">
            <form action="Controller" method="post"  algin="center">
                <div class="w3-col w3-orange" style="width: 1070px; height: 70px; ">
                    ...
                    <div style="padding-top: 18px;padding-right:  600px">
                        <button class="w3-button w3-round w3-white" value="Dangnhap" name="btnAction" ><a href="Controller?btnAction=Dangnhap" style="text-decoration: none">Đăng nhập</a></button>
                        <button class="w3-button w3-round w3-white" value="Dangky" name="btnAction" ><a href="NewLogin_1.jsp" style="text-decoration: none">Đăng Ký</a></button>
                        <button class="w3-button w3-round w3-white" value="Giohanga" name="btnAction" ><a href="Controller?btnAction=Giohanga" style="text-decoration: none">Giỏ Hàng</a></button>
                    </div>
                </div>
                </header>
