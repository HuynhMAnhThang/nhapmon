...
<html>
    ...
    <center>
        <div style="width: 1070px" >
                                ...
                                <form>
                                    ...
                                    <c:forEach var="rows" items="${shop}">
                                        ...
                                        <tr>
                                            ...
                                            <td>${rows.value.quantity * rows.value.sanpham.price} $</td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2"><a href="${add}">Mua Thêm</a></td>
                                        <td><input type="submit" value="Remove" name="btnAction" class="w3-button w3-round w3-red"/></td>
            ...
            <br> <td><input class="w3-button w3-round w3-green" type="submit" value="Thanh Toan" onclick="thongbao()" name="btnAction"/></td>
